...
- 실제 데이터 테이블 예시를 보면서... 매니저 테이블과, 직원 테이블이 두개가 있다. 
  로우 하나씩 보면 직원 테이블에서 reports_to에 적힌 숫자를 보고
...
select 
 ...
 group by m.employee_id  -- 어차피 employee_id가 유니크하니까 m.name은 group by에 넣을 필요 없음.
