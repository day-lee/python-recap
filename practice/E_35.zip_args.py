...
def question_16(*args, weights=None) -> list[float]:
    ...
    # if not weights:
    #     return []
    # zipped = zip(args, weights)
    # r = [score * weight for score, weight in zipped]
    # print(r)

    # new_list = []
    # zipped = zip(args, weights) 
    # for score, weight in zipped:
    #     # print(score, weight)
    #     new_list.append(score * weight)
